...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Eleganza", path: "/about" },
    { label: "Benefits of REACH Eleganza", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    { label: "REACH Eleganza Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Eleganza
            </Link>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email icon for REACH Eleganza" className="w-8 icon-a52356" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp icon for REACH Eleganza" className="w-8 icon-a52356" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form icon for REACH Eleganza" className="w-7 icon-a52356" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
